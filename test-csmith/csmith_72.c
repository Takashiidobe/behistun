...
/* --- GLOBAL VARIABLES --- */
static union U1 g_4 = {0x62C9L};/* VOLATILE GLOBAL g_4 */
static volatile uint64_t g_5 = 0x4AD744D0289A6957LL;/* VOLATILE GLOBAL g_5 */
...
static int32_t  func_1(void)
{ /* block id: 0 */
    union U1 *l_3[3][6][1] = {{{&g_4},{&g_4},{&g_4},{&g_4},{&g_4},{&g_4}},{{&g_4},{&g_4},{&g_4},{&g_4},{&g_4},{&g_4}},{{&g_4},{&g_4},{&g_4},{&g_4},{&g_4},{&g_4}}};
    union U1 **l_2 = &l_3[1][5][0];
    int32_t l_8 = 0x50B5F0B1L;
    int i, j, k;
    (*l_2) = (void*)0;
    ++g_5;
    return l_8;
