...
/* --- GLOBAL VARIABLES --- */
static int32_t g_3[3] = {0x5AB06C0EL,0x5AB06C0EL,0x5AB06C0EL};
static volatile uint32_t g_11 = 0xFC5C3C3AL;/* VOLATILE GLOBAL g_11 */
