...
/* --- GLOBAL VARIABLES --- */
static volatile uint64_t g_2 = 0xF1D8987F2FB5A5EFLL;/* VOLATILE GLOBAL g_2 */
static int32_t g_6 = 0x92F644ACL;
static int32_t * volatile g_5[4] = {&g_6,&g_6,&g_6,&g_6};
