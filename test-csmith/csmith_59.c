...
/* --- GLOBAL VARIABLES --- */
static volatile uint32_t g_2 = 0x6EC79CF1L;/* VOLATILE GLOBAL g_2 */
static int32_t g_5 = 0x11015AA9L;
...
{ /* block id: 0 */
    ...
    { /* block id: 1 */
        ...
        { /* block id: 5 */
            int32_t *l_9[10] = {&g_5,&g_5,&g_5,&g_5,&g_5,&g_5,&g_5,&g_5,&g_5,&g_5};
            int32_t **l_10 = &l_9[2];
            int i;
            l_9[2] = (void*)0;
            (*l_10) = (*g_7);
