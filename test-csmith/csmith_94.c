...
static int32_t g_5 = 0x152C58FBL;
...
static union U0  func_1(void)
{ /* block id: 0 */
    int32_t l_2 = 0xB546158DL;
    int32_t l_12 = (-1L);
    union U0 l_18 = {-6L};
    (*g_4) &= l_2;
    (*g_6) = (*g_4);
    for (l_2 = (-29); (l_2 > (-17)); l_2 = safe_add_func_uint32_t_u_u(l_2, 1))
    { /* block id: 5 */
        uint32_t l_9[9] = {1UL,1UL,1UL,1UL,1UL,1UL,1UL,1UL,1UL};
        int i;
