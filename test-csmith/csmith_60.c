...
static volatile uint32_t g_4[1][4][7] = {{{1UL,0x4E5A945CL,0UL,0UL,0x4E5A945CL,1UL,0x4E5A945CL},{1UL,0x44C3F4F8L,0x44C3F4F8L,1UL,0x0D018D30L,1UL,0x44C3F4F8L},{18446744073709551615UL,18446744073709551615UL,1UL,0UL,1UL,18446744073709551615UL,18446744073709551615UL},{0x81ECA6C8L,0x44C3F4F8L,0xD621EC21L,0x44C3F4F8L,0x81ECA6C8L,0x81ECA6C8L,0x44C3F4F8L}}};
static union U3 g_10 = {0xF13BCF59F89F2E07LL};/* VOLATILE GLOBAL g_10 */
...
{ /* block id: 0 */
    ...
    volatile int32_t l_7 = 0xB4B5A9CEL;/* VOLATILE GLOBAL l_7 */
    const int16_t l_8 = 0x0578L;
    int i;
    g_4[0][1][2]--;
    l_7 = g_4[0][1][2];
    if (l_8)
