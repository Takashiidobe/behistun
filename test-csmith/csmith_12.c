...
/* --- GLOBAL VARIABLES --- */
static struct S2 g_3 = {171,-25130,0x6FL,2,3885,3,1,875,-1637,2446};/* VOLATILE GLOBAL g_3 */
...
/* ------------------------------------------ */
/* 
 * reads : g_3.f6 g_4 g_5 g_3
 * writes: g_5
 */
static const struct S2  func_1(void)
{ /* block id: 0 */
    struct S2 *l_2[7][4] = {{&g_3,&g_3,&g_3,&g_3},{&g_3,&g_3,&g_3,&g_3},{&g_3,&g_3,&g_3,&g_3},{&g_3,&g_3,&g_3,&g_3},{&g_3,&g_3,&g_3,&g_3},{&g_3,&g_3,&g_3,&g_3},{&g_3,&g_3,&g_3,&g_3}};
    int i, j;
    l_2[2][2] = l_2[2][2];
    (*g_4) |= g_3.f6;
    return g_3;
